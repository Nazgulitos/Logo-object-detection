...
Для воспроизведения экспериментов и подробностей обучения см. ноутбуки в каталоге `notebooks/`.
...
- `code/main.py`: FastAPI‑приложение. Ленивая загрузка модели (первый запрос), эндпоинты `/detect` и `/healthz`, валидация форматов изображений, обработка ошибок.
